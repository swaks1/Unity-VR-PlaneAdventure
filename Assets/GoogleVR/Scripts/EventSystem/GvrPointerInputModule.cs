...
public class GvrPointerInputModule : BaseInputModule {
  ...
  private bool isPointerHovering = false;
        ...
        //ovde se staveni za da mozat da se smenat nadvor od skiraptata... sekoristat 149 linija
  ...
  public override void Process() {
    ...
    triggerDown = Input.GetButtonDown("Fire2");

    // True if the trigger is held down.
    //triggering = Input.GetMouseButton(0);
    triggering = Input.GetButton("Fire2");
